  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center border-b pb-4">
        ...
        <Link to="/admin/blogs/new" className="bg-brand-600 text-white px-5 py-2.5 rounded-xl flex items-center gap-2 font-bold hover:bg-brand-700 transition-colors">
