      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a href="https://x.com/xrsystem" target="_blank" rel="noopener noreferrer" aria-label="Visit our Twitter profile" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
              <Twitter size={18} />
            </a>
            <a href="https://www.linkedin.com/company/xrsystem/" target="_blank" rel="noopener noreferrer" aria-label="Visit our LinkedIn profile" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
              <Linkedin size={18} />
            </a>
            <a href="https://github.com/xrsystem" target="_blank" rel="noopener noreferrer" aria-label="Visit our GitHub profile" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
              <Github size={18} />
            </a>
            <a href="https://www.instagram.com/xrsystem.in" target="_blank" rel="noopener noreferrer" aria-label="Visit our Instagram profile" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
              <Instagram size={18} />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Visit our Facebook profile" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
              <Facebook size={18} />
            </a>
            <a href="https://www.youtube.com/channel/UCy0jrE3QfB4q_dYFnK51-DQ" target="_blank" rel="noopener noreferrer" aria-label="Visit our YouTube channel" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
              <Youtube size={18} />
            </a>
            <a href="https://www.reddit.com/user/XRsystem" target="_blank" rel="noopener noreferrer" aria-label="Visit our Reddit profile" className="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-brand-600 hover:text-white transition-all hover:-translate-y-1 shadow-md">
